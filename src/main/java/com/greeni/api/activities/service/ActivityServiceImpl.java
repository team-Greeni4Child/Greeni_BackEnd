...
public class ActivityServiceImpl implements ActivityService {
    ...
    public ActivityResponseDTO.GetActivitySummaryListResponse getActivitySummaryList(Long memberId, Long profileId, int page, int size) {
        // Profile 엔티티 조회
        ...
        Page<Activity> activityPage = activityRepository.findAllByProfileIdOrderByCreatedAtDesc(profileId, pageable);

        // 날짜별 그룹핑
        LinkedHashMap<LocalDate, List<Activity>> grouped = activityPage.getContent().stream()
