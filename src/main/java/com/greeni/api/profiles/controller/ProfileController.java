...
import com.greeni.api.profiles.controller.docs.ProfileControllerDocs;
...
public class ProfileController implements ProfileControllerDocs {
	...
	public ResponseEntity<CommonResponse<ProfileResponseDTO.UpdateProfileResponse>> changeProfile(
		...
		ProfileResponseDTO.UpdateProfileResponse result = profileService.updateProfile(customUserDetails.getId(),
			profileId, dto);
