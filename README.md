...
| **송민아** | Backend | • **ERD 및 API 아키텍처 설계**<br>• **회원가입 로직 구현**<br>• AWS S3 연동을 통한 **오디오/이미지 업로드 API 구축**<br>• 일기 저장, 조회 및 fastapi 서버와의 통신을 통한 **일기 로직 구현**<br>• GitHub Actions 기반 **CI/CD 파이프라인 및 AWS 자동 배포 구축**                          |   [@ssongmina](https://github.com/ssongmina)   |
